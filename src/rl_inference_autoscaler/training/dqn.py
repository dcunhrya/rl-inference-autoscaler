...
from rl_inference_autoscaler.training.config import DQNSettings, build_dqn_config
from rl_inference_autoscaler.training.runtime import (
    dqn_mlflow_params,
    extract_dqn_metrics,
    finish_mlflow_run,
    init_ray_local,
...
def main() -> None:
    ...
    settings = DQNSettings(
        ...
        lr=args.lr if args.lr is not None else DQNSettings().lr,
    )
